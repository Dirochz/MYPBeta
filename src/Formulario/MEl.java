...
public final class MEl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bo_Producto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/inventario.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MEl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
